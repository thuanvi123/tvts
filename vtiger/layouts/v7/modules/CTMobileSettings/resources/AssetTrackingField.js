...
 * All Rights Reserved.
  ***************************************************************************** */
jQuery.Class("CTMobileSettings_AssetTrackingField_Js",{
    editInstance:false,
    getInstance: function(){
        if(CTMobileSettings_AssetTrackingField_Js.editInstance == false){
            var instance = new CTMobileSettings_Settings_Js();
            CTMobileSettings_AssetTrackingField_Js.editInstance = instance;
            return instance;
        }
        return CTMobileSettings_AssetTrackingField_Js.editInstance;
    }
},{
...
jQuery(document).ready(function () {
    var instance = new CTMobileSettings_AssetTrackingField_Js();
