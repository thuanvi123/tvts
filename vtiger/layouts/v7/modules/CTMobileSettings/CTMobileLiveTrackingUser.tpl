...
<div class="container-fluid">
    <div class="widget_header row-fluid">
    	<a class="btn btn-info pull-right" href="{CTMobileSettings_Module_Model::$CTMOBILE_DETAILVIEW_URL}"><i style="font-size:20px !important;" class="fa fa-home"></i></a>
        <h3>{vtranslate('CRMTiger Mobile Apps - LiveTracking Users', 'CTMobileSettings')}</h3>
    </div>
    <hr>
       <h5 style="margin-left:20px;">{vtranslate('Add/Remove users from list to track locations of users','CTMobileSettings')}</h5>
