...
{strip}
	<div class="col-sm-12 col-xs-12 module-action-bar clearfix coloredBorderTop">
		<div class="module-action-content clearfix {$MODULE}-module-action-content">
			<div class="col-lg-6 col-md-6 module-breadcrumb module-breadcrumb-{$smarty.request.view} transitionsAllHalfSecond">
			...
			<div class="col-lg-6 col-md-6 pull-right">
				<div id="appnav" class="navbar-right">
					<ul class="nav navbar-nav">
						<li>
	                    <button type="button" class="btn btn-info module-buttons" onclick='window.location.href="{CTMobileSettings_Module_Model::$CTMOBILE_DETAILVIEW_URL}"' style="background:#287DF2 !important;color:#fff !important;">{vtranslate('Go To CRMTiger Settings',$MODULE)}</button>
	                    </li>
