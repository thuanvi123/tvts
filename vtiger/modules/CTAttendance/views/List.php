...
class CTAttendance_List_View extends Vtiger_Index_View {
	...
	function getCheckInLocation($recordId){
		$check_in_location = "";
		if($recordId){
			$recordModel = CTAttendance_Record_Model::getInstanceById($recordId,'CTAttendance');
