...
class CTMobileSettings_Module_Model extends Vtiger_Module_Model {
	...
	static function sendpushnotification($message,$devicekey,$device_type,$title) {
        ...
        if($device_type == 'ios'){
			...
			$dataPayload = array('type'=>'normal','recordId' => '' , 'moduleName' => '');
			$fcmFields = array(
				'to' => $devicekey ,
				'priority' => 'high',
			...
			$dataPayload = array('type'=>'normal','message' => $message, 'title' => $title, 'recordId' => '' , 'moduleName' => '');
	...
	static function getCTRequirements(){
		...
		$tables = array('ctmobile_address_modules','ctmobile_address_fields','ctmobile_api_settings','ctmobile_license_settings','ctmobile_livetracking_users','ctmobile_access_users','ct_address_lat_long','ctmobile_userderoute','ctmobile_language_section','ctmobile_language_keyword','ctmobile_dashboard_sequence','ctmobile_vcard_fields','ctmobile_asset_field','ctmobile_barcode_fields','ctmobile_timetracking_modules','ctmobile_routestatus','ctmobile_routegeneralsettings','ctmobile_signature_fields');
