...
class CTMobileSettings_NonAddressPopup_View extends Vtiger_Popup_View {
	...
	public function initializeListViewContents(Vtiger_Request $request, Vtiger_Viewer $viewer) {
		...
		$viewer->assign('VIEW', 'NonAddressPopup');
	...
	public function getListViewEntries($pagingModel,$listViewModel) {
	    ...
	    $listQuery  = $listQuery." AND $basetable.$basetableid NOT IN (SELECT recordid FROM ct_address_lat_long WHERE moduleid = $moduleId ) ";
