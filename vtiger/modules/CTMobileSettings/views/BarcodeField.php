...
class CTMobileSettings_BarcodeField_View extends Settings_Vtiger_Index_View {
    ...
    public function process(Vtiger_Request $request) {
        ...
        echo $viewer->view('BarcodeFieldSettings.tpl', $module, true);
    } 
    ...
    function getHeaderScripts(Vtiger_Request $request) {
        ...
        $jsFileNames = array(
            "modules.CTMobileSettings.resources.BarcodeField",
        );
