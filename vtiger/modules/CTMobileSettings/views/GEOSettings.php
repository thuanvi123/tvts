...
class CTMobileSettings_GEOSettings_View extends Settings_Vtiger_Index_View {
    ...
    function renderSettingsUI(Vtiger_Request $request) {
		...
		$GoogleApi = CTMobileSettings_Module_Model::getGoogleApiKey();
        $viewer->assign('API_KEY', $GoogleApi);
        ...
        echo $viewer->view('GEOSettings.tpl',$module,true);
    }
