...
Class CTRoutePlanning_Edit_View extends Vtiger_Edit_View {
	...
	public function process(Vtiger_Request $request) {
		...
		$existingRelatedContacts = $recordModel->getRelatedCTRouteInfo();
		$viewer->assign('RELATED_CTROUTE', $existingRelatedContacts);
