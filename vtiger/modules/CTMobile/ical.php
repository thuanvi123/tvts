...
// url format: http://localhost:81/modules/CTMobile/ical.php/username@mail.com/password
...
if (vtlib_isModuleActive('Mobile')) {
	CTMobile_ICAL::process($matches[1], $matches[2]);
}
